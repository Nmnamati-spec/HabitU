...
public class CommunitySettingsActivity extends AppCompatActivity {
    ...
    TextView tvCommName, tvCommMeta, tvPendingCount, btnBack;
        ...
        btnDeleteCommunity.setOnClickListener(v ->
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("This will permanently delete "
                                + communityName + " and cannot be undone.")
    ...
    private void loadCommunityData() {
        db.collection("communities").document(communityId).get()
                .addOnSuccessListener(doc -> {
                    ...
                    java.util.List<?> pending = (java.util.List<?>) doc.get("pendingRequestIds");
                    java.util.List<?> members = (java.util.List<?>) doc.get("memberIds");
